...
class HmcCommandStack():
    ...
    HMC_CMD_OPT = {'LSHMC': {'-N': ' -n ',
                   ...
                   'UPDLIC': {'-M': ' -m ',
                              ...
                              '-D': ' -d '},
                   'LSLIC': {'-M': ' -m ',
                             '-T': {'SYS': ' -t sys', 'IO': ' -t io', 'SRIOV': ' -t sriov',
                                    'BMC': ' -t bmc', 'PNOR': ' -t pnor', 'BMCPNOR': ' -t bmcpnor'},
                             '-L': ' -l ',
                             '-H': ' -h ',
                             '-U': ' -u ',
                             '--PASSWD': ' --passwd ',
                             ...
                             '-F': {'SPNAMELEVEL': ' -F activated_spname,activated_level,ecnumber',
                                    'SRIOVLEVEL': ' -F adapter_id,active_adapter_driver_level,active_adapter_level',
                                    'IOLEVEL': ' -F logical_device,current_level',
                                    'AVAILABLE_LEVEL_FIELDS': ' -F level,spname,concurrency'}},
