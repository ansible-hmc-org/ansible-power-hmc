...
EXAMPLES = '''
examples:
  - name: Minimal example – single HMC
  ...
  - name: Inventory with only VIOS partitions
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC_Username>
  ...
  - name: Multiple HMCs, running partitions only
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC1_Username>
  ...
  - name: Group running partitions by OS version
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC1_Username>
  ...
  - name: Group running partitions by PartitionType
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC1_Username>
  ...
  - name: Exclude partitions by IP, LPAR name, or system
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC2_Username>
  ...
  - name: Inventory of operating Power Servers grouped by SystemType
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC2_Username>
  ...
  - name: Inventory of running partitions and operating systems with groups
    plugin: ibm.power_hmc.powervm_inventory
    hmc_hosts:
      - hmc: <hmc_host_name>
        user: <HMC2_Username>
